...
<div class="container">
    ...
    <?php
        $name = "Bui Thi Ngoc Linh";
        $student_id = "23070525";
        $course = "INS3064 - Web Development";
        $email="buingoclinhkq@gmail.com";

        $currentDate = date("l, F d, Y");
        $currentTime = date("H:i:s");

        echo "<div class='info'>";
        echo "<p><span class='label'>Student Name:</span> $name</p>";
        echo "<p><span class='label'>Student ID:</span> $student_id</p>";
        echo "<p><span class='label'>Course:</span> $course</p>";
